...
- **Inserisci le quote 1X2** di una giornata (a mano, incollate da un foglio di calcolo, o precaricate da un esempio)
...
├── schedina.py                             # Logica schedina: Shin, Poisson binomiale, ritorno atteso
